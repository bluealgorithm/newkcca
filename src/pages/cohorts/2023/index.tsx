  ...
  return (
    <>
      ...
      <div className="relative bg-[url('/images/kcca2.JPG')] h-[100vh] bg-cover bg-center overflow-hidden">
        <div
          className="absolute top-[1px] left-0 right-0 bottom-0 min-h-[100vh] bg-black"
          style={{
            background: "rgba(21, 21, 21, 0.6)",
            // "linear-gradient(84.59deg, rgba(0, 0, 0, 0.58) 17.84%, rgba(0, 0, 0, 0.17) 52.14%, rgba(0, 0, 0, 0.65) 80.9%)",
          }}
        />
        <div className="relative flex flex-col justify-center items-center text-white h-full px-[20px]">
      ...
      >
        <article className="flex-1 mr-[20px]">
          ...
          <p className="font-[400] font-montserrat text-[16px] leading-6 text-[#3c3838] mb-[20px]">
            Welcome to Kids Code Club Africa 2023, the 5th edition of our
            flagship programme designed to impact the lives of young persons in
            Africa. Our aim this year is to get 2,000 students into the
            programme. Here is a breakdown of what you need to know about the
            KCCA 2023 programme:
          </p>
          {/* </section> */}
          <div id="feature">
            ...
            <p className="font-[400] font-montserrat text-[16px] leading-6 text-[#3c3838] mb-[20px]">
              The Kids Code Club Africa 2023 has some exciting features,
              including an intense Bootcamp and Hackathon, as well as the
              introduction of two interesting programmes: BlockChain Development
            ...
            <p className="font-[300] font-montserrat text-[16px] leading-6 text-[#3c3838] mb-[20px]">
              This is a free, practical digital capacity building and mentorship
              project, designed to equip participants with the necessary coding
              skills. The boot camp for this year is a hybrid one, which means
              that it is both physical and virtual. It would take place in six
              states, including Plateau and Abuja, inclusive. We are expecting
            ...
            <p className="font-[300] font-montserrat text-[16px] leading-6 text-[#3c3838] mb-[20px]">
              {" "}
              Conference & Hackathon The kids in tech conference is the
              showcasing of the talents domiciled in kids, the coming together
              of critical digital tech stakeholders, educational organizations
              and professionals, STEM educationists, federal and state
              government ministries and departments to engage in policy
              formulation or implementation on the development of tech in
              Nigeria.
            </p>
            <p className="font-[300] font-montserrat text-[16px] leading-6 text-[#3c3838] mb-[20px]">
              The Hackathon is a great way to introduce children to the world of
              technology and foster their creativity and problem-solving skills.
              The Hackathon this year is designed to provide a fun and
              collaborative environment for children to explore different areas
              of technology, such as Cybersecurity, Artificial Intelligence,
              Internet of Things, Mobile App Development and build their own
              solutions using these tools to solve real-life problems.
            </p>
            <p className="font-[300] font-montserrat text-[16px] leading-6 text-[#3c3838] mb-[20px]">
              The Hackathon (Coding Competition) would be broken into two
              categories:
            </p>
            ...
            <p className="font-[400] font-montserrat text-[16px] leading-6 text-[#3c3838] mt-[20px]">
              The finalist for the Junior Category would be awarded a cash prize
              of N250,000, while the finalist for the Senior category would be
              awarded a cash prize of N300,000.
            </p>
          </div>
        </article>
      ...
      >
        <article className="flex-1">
          ...
          <div className="mt-[20px] md:mt-[40px]">
            ...
            <ul className="ml-[15px]">
              <li className="font-[300] font-montserrat text-[16px] leading-6 text-[#3c3838] list-disc mb-[10px]">
                Visit our website, www.kidcodeclubafrica.org between March and
                July 2023, and complete the application form{" "}
                <span className="font-[500] text-primary">
                  (Application is ongoing)
                </span>
              </li>
              <li className="font-[300] font-montserrat text-[16px] leading-6 text-[#3c3838] list-disc mb-[10px]">
                Do an online exam and be invited for, and participate in the
                screening process
              </li>
              <li className="font-[300] font-montserrat text-[16px] leading-6 text-[#3c3838] list-disc mb-[10px]">
              ...
              <li className="font-[300] font-montserrat text-[16px] leading-6 text-[#3c3838] list-disc mb-[10px]">
                Wait for the notification via email and prepare to attend the
                Bootcamp in August 2023.
              </li>
              <li className="font-[300] font-montserrat text-[16px] leading-6 text-[#3c3838] list-disc mb-[10px]">
            ...
            <p className="font-[400] font-montserrat text-[16px] leading-6 text-[#3c3838] mt-[8px] mb-[16px]">
              We look forward to welcoming the next generation of young coders
              to Kids Code Club Africa 2023. Join us on this exciting journey of
              digital innovation and technology empowerment.
            </p>
          </div>
        </article>
